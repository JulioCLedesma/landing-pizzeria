// 1. Importa las imágenes desde la nueva ubicación en src/assets
...
export default function Menu() {
  // 2. Define el arreglo de items
  const items = [
    // 3. Usa las variables de las imágenes importadas
    ...
    <section className="py-5">
      <div className="container">
        ...
        <div className="row g-4">
          {/* 4. Recorre el arreglo para crear las tarjetas dinámicamente */}
          {items.map((it, i) => (
